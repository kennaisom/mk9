...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div class="col-2">
		...
		<form method="post" class="register">
			...
			<div class="checkbox">
				<label><input type="checkbox" value="" required="true"> I have read and agreed to the
					<a href="/training-waiver"
					   target="_blank">Training Waiver</a>
				</label>
			</div>
			<div class="checkbox">
				<label><input type="checkbox" value="" required="true"> I have read and agreed to the
					<a href="/boarding-waiver"
					   target="_blank">Boarding Waiver</a>
				</label>
			</div>
			<p class="form-row">
