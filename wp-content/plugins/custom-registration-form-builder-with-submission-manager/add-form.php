...
<div class="crf-main-form">
  ...
  <div class="crf-form-setting">
      ...
      <div class="crf-form-right-area">
        <input name="form_type" id="form_type" type="checkbox" tabindex="10" class="upb_toggle" value="reg_form" <?php if (!empty($row) && $row->form_type=='reg_form'){ echo "checked";}?> style="display:none;" />
    ...
    <div class="crf-form-setting">
      ...
      <?php if(isset($row))$custom_text = $row->custom_text; else $custom_text = ''; wp_editor( $custom_text, 'form_custom_text' );?>
        <?php /*?><textarea tabindex="9" name="form_custom_text" id="form_custom_text"><?php if(!empty($row))echo $row->custom_text; ?></textarea><?php */?>
      </div>
    </div>
    ...
    <div class="crf-form-setting">
      ...
      <?php if(isset($row))$success_message = $row->success_message; else $success_message = ''; wp_editor( $success_message, 'success_message' );?>
        <?php /*?><textarea name="success_message" id="success_message" tabindex="13" required><?php if(!empty($row)) echo $row->success_message; ?></textarea><?php */?>
      </div>
    </div>
...
$args = array(
    ...
    <div class="crf-form-setting autoresponder" style="display:<?php if (!empty($row) && $row->send_email==1){ echo "block";}else {echo 'none';}?>">
      ...
      <?php
	   add_action('media_buttons', array($crf_basic_options,'add_crf_fields_list'));
	    wp_editor( $row->crf_welcome_email_message, 'welcome_email_message');?>
      </div>
    </div>
    ...
    <div class="crf-form-setting">
      ...
      <div class="crf-form-right-area">
       <input type="text" name="submit_button_label" id="submit_button_label" placeholder="Submit" tabindex="14" value="<?php if(isset($submit_button_label)) echo $submit_button_label;?>" />
      </div>
    </div>
    ...
    <?php
    $enable_mailchimp = crf_get_global_option_value('enable_mailchimp');
	...
	<div class="crf-form-setting">
      ...
      <?php
		...
		$api_key = crf_get_global_option_value('mailchimp_key');
    ...
    <div class="crf-form-setting">
      ...
      <div class="crf-form-right-area">
	   ...
	   if(isset($newoption))echo $newoption;
	    crf_fields_dropdown_options($_REQUEST['id'],$mailchimp_emailfield);?>
        </select>
      </div>
    </div>
    ...
    <div class="crf-form-setting">
      ...
      <div class="crf-form-right-area">
       ...
       <?php crf_fields_dropdown_options($_REQUEST['id'],$mailchimp_firstfield);?>
        </select>
      </div>
    </div>
    ...
    <div class="crf-form-setting">
      ...
      <div class="crf-form-right-area">
       ...
       <?php crf_fields_dropdown_options($_REQUEST['id'],$mailchimp_lastfield);?>
        </select>
      </div>
    </div>
     <div class="crf-form-setting">
      ...
      <div class="crf-form-right-area">
        <input name="optin_box" id="optin_box" type="checkbox" tabindex="15" class="upb_toggle" value="1" <?php if(isset($optin_box) && $optin_box==1){ echo "checked";}?> style="display:none;" />
    ...
    <div class="crf-form-setting optin_box_html" style="display:<?php if(isset($optin_box) && $optin_box==1){ echo "block";}else {echo 'none';}?>">
      ...
      <div class="crf-form-right-area">
        <textarea name="optin_box_text" id="optin_box_text" tabindex="16"><?php if(!empty($optin_box_text)) echo $optin_box_text; ?></textarea>
    ...
    <div class="crf-form-setting" id="limitation_date_html" style="display:<?php if(isset($expiry_type) && ($expiry_type=='date' || $expiry_type=='both')) echo 'block'; else echo 'none';?>;">
      ...
      <div class="crf-form-right-area">
         <input type="text" name="expiry_date" id="expiry_date" tabindex="20" value="<?php if(isset($expiry_date)) echo $expiry_date; ?>" class="crf_date rm_tcal" onBlur="check_date()" />
    ...
    <div class="crf-form-footer">
      <div class="crf-form-button">
        ...
        <input type="submit" value="<?php _e('Save',$textdomain);?>" name="submit_form" id="submit_form" tabindex="15" />
        <input type="reset" />
